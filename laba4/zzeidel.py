...
R = int(input("Amount of rows:"))
C = int(input("Amount of columns:"))
matrix, beta, alpha = np.zeros((R, C), dtype=Frac), [[0] for j in range(R)], \
                      np.zeros((R, C - 1), dtype=Frac)
...
print("Amount of operations is ", time)
